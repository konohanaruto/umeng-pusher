...
use Konohanaruto\UmengPusher\Android\AndroidBroadcast;
use Konohanaruto\UmengPusher\Android\AndroidCustomizedcast;
use Konohanaruto\UmengPusher\Android\AndroidFilecast;
use Konohanaruto\UmengPusher\Android\AndroidGroupcast;
use Konohanaruto\UmengPusher\Android\AndroidUnicast;
use Konohanaruto\UmengPusher\Android\AndroidListcast;
use Konohanaruto\UmengPusher\Ios\IOSBroadcast;
use Konohanaruto\UmengPusher\Ios\IOSFilecast;
use Konohanaruto\UmengPusher\Ios\IOSGroupcast;
use Konohanaruto\UmengPusher\Ios\IOSUnicast;
use Konohanaruto\UmengPusher\Ios\IOSListcast;
use Konohanaruto\UmengPusher\AndroidNotification;
use Konohanaruto\UmengPusher\Ios\IOSCustomizedcast;
...
class Demo {
	...
	function sendIOSUnicast() {
		try {
			...
			// Set your device tokens here
			$unicast->setPredefinedKeyValue("device_tokens",    "xx"); 
			$unicast->setPredefinedKeyValue("alert", "推送测试");
...
$demo = new Demo("appkey", "master secret");
$demo->sendIOSUnicast();
